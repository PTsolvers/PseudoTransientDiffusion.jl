...
fid = fopen('../output/out_diff_3D_lin.txt','r'); diff_3D_lin = fscanf(fid, '%d %d %d %d %d', [5 Inf]); fclose(fid);
...
fid = fopen('../output/out_diff_3D_linstep.txt','r'); diff_3D_linstep = fscanf(fid, '%d %d %d %d %d', [5 Inf]); fclose(fid);
