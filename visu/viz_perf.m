...
fid = fopen('../output/out_diff_2D_nonlin_perf_ampere.txt','r'); diff_2D_ampere = fscanf(fid, '%d %d %d %f %f %f %f', [7 Inf]); fclose(fid); % nx ny ittot t_toc A_eff t_it T_eff
...
fid = fopen('../output/out_diff_3D_nonlin_perf_ampere.txt','r'); diff_3D_ampere = fscanf(fid, '%d %d %d %d %d %f %f %f %f', [9 Inf]); fclose(fid); % np nx ny nz ittot t_toc A_eff t_it T_eff
...
fid = fopen('../../PseudoTransientStokes/output/out_Stokes3D_ve_perf_ampere.txt','r'); stokes_3D_ampere = fscanf(fid, '%d %d %d %d %d %f %f %f %f', [9 Inf]); fclose(fid); % np nx ny nz ittot t_toc A_eff t_it T_eff
...
fid = fopen('../output/out_diff_3D_nonlin_multixpu_perf_ampere.txt','r'); diff_3D_mxpu_ampere = fscanf(fid, '%d %d %d %d %d %f %f %f %f', [9 Inf]); fclose(fid); % np nx ny nz ittot t_toc A_eff t_it T_eff
...
fid = fopen('../../PseudoTransientStokes/output/out_Stokes3D_ve_xpu_perf_ampere.txt','r'); stokes_3D_mxpu_ampere = fscanf(fid, '%d %d %d %d %d %f %f %f %f', [9 Inf]); fclose(fid); % np nx ny nz ittot t_toc A_eff t_it T_eff
...
diff_2D_ampere_2 = average_exp(diff_2D_ampere, nrep, my_type);
...
semilogx(diff_2D_ampere_2(1,:),diff_2D_ampere_2(end,:), '-o', ...
...
hold on
semilogx(diff_2D_octo_2(1,:),T_peak_ampere*ones(size(diff_2D_octo_2(1,:))),'k:', ...
...
semilogx(diff_3D_ampere_2(2,:),diff_3D_ampere_2(end,:), '-o', ...
         diff_3D_volta_2(2,:),diff_3D_volta_2(end,:), '-o', ...
         diff_3D_daint_2(2,:),diff_3D_daint_2(end,:), '-o', ...
         'linewidth',3, 'MarkerFaceColor','k'), set(gca, 'fontsize',FS, 'linewidth',1.4)
hold on
semilogx(diff_3D_volta_2(2,:),T_peak_ampere*ones(size(diff_3D_volta_2(2,:))),'k:', ...
...
% print('fig_perf23D_diff_3','-dpng','-r300')
end
%%
if fig2==1
